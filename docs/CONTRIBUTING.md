...
# `wtsi-hgi/hlarnaseq`: Contributing guidelines

Hi there!
Thanks for taking an interest in improving wtsi-hgi/hlarnaseq.

This page describes the recommended nf-core way to contribute to both wtsi-hgi/hlarnaseq and nf-core pipelines in general, including:

- [General contribution guidelines](#general-contribution-guidelines): common procedures or guides across all nf-core pipelines.
- [Pipeline-specific contribution guidelines](#pipeline-specific-contribution-guidelines): procedures or guides specific to the development conventions of wtsi-hgi/hlarnaseq.

> [!NOTE]
> If you need help using or modifying wtsi-hgi/hlarnaseq, ask on the [GitHub issue tracker](https://github.com/wtsi-hgi/hlarnaseq/issues) or contact Gennadii Zakharov <gz3@sanger.ac.uk> directly. This pipeline is built from the nf-core template but is not an official nf-core pipeline, so please do not ask about it in the nf-core community channels.
...
- [ ] Check whether a GitHub [issue](https://github.com/wtsi-hgi/hlarnaseq/issues) about your idea already exists. If an issue does not exist, create one so that others are aware you are working on it.
- [ ] [Fork](https://help.github.com/en/github/getting-started-with-github/fork-a-repo) the [wtsi-hgi/hlarnaseq repository](https://github.com/wtsi-hgi/hlarnaseq) to your GitHub account.
...
For further information and help, see the [wtsi-hgi/hlarnaseq documentation](usage.md) or ask on the [GitHub issue tracker](https://github.com/wtsi-hgi/hlarnaseq/issues), or contact Gennadii Zakharov <gz3@sanger.ac.uk>.

### GitHub Codespaces

You can contribute to wtsi-hgi/hlarnaseq without installing a local development environment on your machine by using [GitHub Codespaces](https://github.com/codespaces).
...
To get started, open the repository in [Codespaces](https://github.com/wtsi-hgi/hlarnaseq/codespaces).
...
nf-core semi-standardises how you write code and other contributions to make the wtsi-hgi/hlarnaseq code and processing logic more understandable for new contributors and to ensure quality.
